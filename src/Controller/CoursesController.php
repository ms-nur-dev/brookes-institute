...
{
    /**
     * Centralisation des données des formations pour les rendre accessibles
     * à l'ensemble des méthodes du contrôleur.
     */
    private function getCoursesData(): array
    {
        $commonPublic = 'Professionnels, demandeurs d\'emploi, étudiants ou toute personne souhaitant un perfectionnement ciblé en anglais dans un cadre professionnel.';
        ...
        return [
            ...
            'light' => [
                ...
                'hours' => 20,
                'price' => 1500,
                'features' => ['Consolidation des bases', 'Compétences contextuelles'],
            ...
            'basic' => [
                ...
                'hours' => 33,
                'price' => 2500,
                'features' => ['Aisance en échanges complexes', 'Anglais des affaires'],
            ...
            'midway' => [
                ...
                'hours' => 40,
                'price' => 2800,
                'features' => ['Compétences solides et autonomes', 'Réussite tests (TOEIC, TOEFL)'],
            ...
            'performer' => [
                ...
                'hours' => 50,
                'price' => 3600,
                'features' => ['Maîtrise codes culturels', 'Échanges professionnels complexes'],
            ...
            'full' => [
                ...
                'hours' => 60,
                'price' => 4200,
                'features' => ['Maîtrise fluide et stratégique', 'Leadership en anglais'],
